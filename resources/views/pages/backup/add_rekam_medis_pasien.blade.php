                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10 form-group">
                                            <input type="text" class="form-control" rows="3" placeholder="Nama Lengkap" />
                                        </div>
                                        <div class="col-md-2">
                                            <label>Email</label>
                                        </div>
                                        <div class="col-md-10 form-group">
                                            <input type="email" class="form-control" rows="3" placeholder="Email" />
                                        </div>
                                        <div class="col-md-2">
                                            <label>No. Telp</label>
                                        </div>
                                        <div class="col-md-10 form-group">
                                            <input type="number" class="form-control" rows="3" placeholder="No. Telp" />
                                        </div>
                                        <div class="col-md-2">
                                            <label>Alamat</label>
                                        </div>
                                        ...
                                        <div class="col-md-10 form-group">
                                            ...
                                            <div class="col-md-12 form-group">
                                                <textarea type="text" class="form-control" id="riwayat" name="tanggal_kunjungan" placeholder="Riwayat Perawatan" disabled></textarea>
                                            </div>
                                        </div>
            ...
            <div class="col-lg-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h5 id="kondisi_gigi_1"></h5>
                        <h4>Kondisi Gigi 17: </h4>
                        <h5 id="kondisi_gigi_2"></h5>
                        <h4>Kondisi Gigi 16: </h4>
                        <h5 id="kondisi_gigi_3"></h5>
                        <h4>Kondisi Gigi 15: </h4>
                        <h5 id="kondisi_gigi_4"></h5>
                        <h4>Kondisi Gigi 14: </h4>
                        <h5 id="kondisi_gigi_5"></h5>
                        <h4>Kondisi Gigi 13: </h4>
                        <h5 id="kondisi_gigi_6"></h5>
                        <h4>Kondisi Gigi 12: </h4>
                        <h5 id="kondisi_gigi_7"></h5>
                        <h4>Kondisi Gigi 11: </h4>
                        <h5 id="kondisi_gigi_8"></h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h5 id="kondisi_gigi_9"></h5>
                        <h4>Kondisi Gigi 22: </h4>
                        <h5 id="kondisi_gigi_10"></h5>
                        <h4>Kondisi Gigi 23: </h4>
                        <h5 id="kondisi_gigi_11"></h5>
                        <h4>Kondisi Gigi 24: </h4>
                        <h5 id="kondisi_gigi_12"></h5>
                        <h4>Kondisi Gigi 25: </h4>
                        <h5 id="kondisi_gigi_13"></h5>
                        <h4>Kondisi Gigi 26: </h4>
                        <h5 id="kondisi_gigi_14"></h5>
                        <h4>Kondisi Gigi 27: </h4>
                        <h5 id="kondisi_gigi_15"></h5>
                        <h4>Kondisi Gigi 28: </h4>
                        <h5 id="kondisi_gigi_16"></h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h5 id="kondisi_gigi_17"></h5>
                        <h4>Kondisi Gigi 37: </h4>
                        <h5 id="kondisi_gigi_18"></h5>
                        <h4>Kondisi Gigi 36: </h4>
                        <h5 id="kondisi_gigi_19"></h5>
                        <h4>Kondisi Gigi 35: </h4>
                        <h5 id="kondisi_gigi_20"></h5>
                        <h4>Kondisi Gigi 34: </h4>
                        <h5 id="kondisi_gigi_21"></h5>
                        <h4>Kondisi Gigi 33: </h4>
                        <h5 id="kondisi_gigi_22"></h5>
                        <h4>Kondisi Gigi 32: </h4>
                        <h5 id="kondisi_gigi_23"></h5>
                        <h4>Kondisi Gigi 31: </h4>
                        <h5 id="kondisi_gigi_24"></h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h5 id="kondisi_gigi_25"></h5>
                        <h4>Kondisi Gigi 42: </h4>
                        <h5 id="kondisi_gigi_26"></h5>
                        <h4>Kondisi Gigi 43: </h4>
                        <h5 id="kondisi_gigi_27"></h5>
                        <h4>Kondisi Gigi 44: </h4>
                        <h5 id="kondisi_gigi_28"></h5>
                        <h4>Kondisi Gigi 45: </h4>
                        <h5 id="kondisi_gigi_29"></h5>
                        <h4>Kondisi Gigi 46: </h4>
                        <h5 id="kondisi_gigi_30"></h5>
                        <h4>Kondisi Gigi 47: </h4>
                        <h5 id="kondisi_gigi_31"></h5>
                        <h4>Kondisi Gigi 48: </h4>
                        <h5 id="kondisi_gigi_32"></h5>
                    </div>
                </div>
            </div>
        </div>
